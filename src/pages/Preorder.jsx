  ...
  <Head></Head>
    ...
    <section className=" relative -top-25  flex items-end  h-[60vh]  sm:h-[100vh] w-full px-6  bg-cover bg-center "
      style={{ backgroundImage: "url('/Group 26773.png')" }}>    
                          ...
                          <h1 className="text-3xl md:text-7xl font-light font-title uppercase">
                               {lines.map((line, lineIndex) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-[391px]:text-center ">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <div className="flex-1">
            <label htmlFor="firstName" className="block text-[#757575] text-base font-light mb-2">
              First Name
            </label>
            <input
              type="text"
          ...
          <div className="flex-1">
            <label htmlFor="lastName" className="block text-[#757575] text-base font-light mb-2">
              Last Name
            </label>
            <input
              type="text"
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <div className="flex-1">
            <label htmlFor="email" className="block text-[#757575] text-base font-light mb-2">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="flex-1">
            <label htmlFor="phone" className="block text-[#757575] text-base font-light mb-2">
              Phone Number
            </label>
            <input
              type="tel"
